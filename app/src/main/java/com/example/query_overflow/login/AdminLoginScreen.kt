...
// sparkle icon
    ...
    Column(
        ...
        Button(
            onClick = {
                // Assuming adminSignIn is a suspend function. If not, adjust accordingly.
                firebaseHelper.adminSignIn(email.value, password.value,
                    onSuccess = {
                        navController.navigate(Screen.Admin.route)
                    },
            ...
            // Apply dynamic colors based on the button's enabled state
